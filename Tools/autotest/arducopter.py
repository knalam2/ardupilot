...
#            self.send_debug_trap()
    ...
    def test_EK3_ext_nav_vel_without_vert(self):
        """
        ...
        tstart = self.get_sim_time()
        while True:
            msg = self.mav.recv_match(type="EKF_STATUS_REPORT", timeout=5, blocking=True)
            if msg:
...
#        self.set_rc(1, 1500)  # note we are still in RC fail!
    ...
    def tests2b(self):  # this block currently around 9.5mins here
        ...
        ret = ([
            ...
            self.test_EK3_ext_nav_vel_without_vert,
